...
def loadtocrop(test=False):
    ...
    for shp in range(6):
        for i in range(size):
            ...
            if(test):
                o_landmark_path = 'data/test/test_' + str(i).zfill(4) + '.pts'       # original image path
                o_image_path = 'data/test/test_' + str(i).zfill(4) + '.png'             # original landmark path
                landmark_path = 'data/test/landmarks/test_' + str(ctr).zfill(4) + '.txt'         # preprocessed image path
                image_path = 'data/test/images/test_' + str(ctr).zfill(4) + '.png'               # preprocessed landmark path
            else:
                o_landmark_path = 'data/train/train_' + str(i).zfill(4) + '.pts'     # original image path
                o_image_path = 'data/train/train_' + str(i).zfill(4) + '.png'           # original landmark path
                landmark_path = 'data/train/landmarks/train_' + str(ctr).zfill(4) + '.txt'       # preprocessed image path
                image_path = 'data/train/images/train_' + str(ctr).zfill(4) + '.png'             # preprocessed landmark path
            ...
            resize_image = cv2.resize(crop_image, (416, 416))
